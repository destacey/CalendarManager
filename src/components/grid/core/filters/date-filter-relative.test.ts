...
// buildRelativeDateFilter does real date math (subtract/startOf/quarter). The
// global dayjs mock in src/test/setup.ts is a formatting-only shim without
// that math, so opt this file back into the real library — needed both for
// the direct `import dayjs` below and for the module under test.
vi.unmock('dayjs')
