...
// buildDateTree strict-parses YYYY-MM-DD keys and formats month names. The
// global dayjs mock in src/test/setup.ts can't strict-parse or format month
// names, so opt this file back into the real library.
vi.unmock('dayjs')
