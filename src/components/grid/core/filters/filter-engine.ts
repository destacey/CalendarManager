 ...
 * its `type`. Assign to a column via `filterFn: dataGridColumnFilter`.
 */
export const dataGridColumnFilter: FilterFn<any> = (
  row,
  columnId,
  filterValue,
) => {
 ...
 * accessor is the comma-joined names). The default {@link dataGridColumnFilter}
