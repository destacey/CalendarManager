...
/**
 * A header's content, wrapped in a {@link GridTooltip} when the column
...
export function useHeaderCellSortable(
  ...
  return {
    ...
    style: {
      ...
      // grid's header cells are z-index 20 and pinned headers 22 (see the
      // grid's own stylesheet); this inline value must clear both so the
