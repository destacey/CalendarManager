/**
 * Column autosize for this grid. TanStack has no built-in autosize, so
 ...
 *  space whether currently visible or not). Must track the header row's own
 *  CSS — its content gap and cell padding — wherever that is eventually
 *  defined. */
