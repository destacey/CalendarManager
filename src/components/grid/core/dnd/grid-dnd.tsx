...
// row wrapper + drag-handle context. Grid-agnostic — this only covers flat
// sibling reordering. The upstream template also had a tree-only reparenting
// projection (`tree-projection.ts`) for hierarchical grids; it was not ported
// here because this app has no hierarchical grid data, and nothing in this
// file imports it.
