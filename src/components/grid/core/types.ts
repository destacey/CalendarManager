 ...
 */
export type DataGridColumnType = 'yesNo' | 'dateOnly' | 'dateTime'

/**
 * Extended column metadata for this grid, stored in TanStack's
 * `columnDef.meta`.
 *
...
export interface DataGridColumnMeta {
   ...
   * style). The grid wraps the header content in GridTooltip automatically —
