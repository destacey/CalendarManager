...
import type { DataGridColumnType, DataGridColumnMeta } from './types'
import type { RowData } from '@tanstack/react-table'

// DataGridColumnType keys the registry below.

/**
 * This grid's column types — a declarative registry mirroring AG Grid's
...
interface ColumnTypeDef<T extends RowData> {
  ...
  filterType?: DataGridColumnMeta['filterType']
  filterOptions?: DataGridColumnMeta['filterOptions']
 ...
 */
const registry: {
  [K in DataGridColumnType]: <T extends RowData>() => ColumnTypeDef<T>
} = {
