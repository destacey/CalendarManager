 ...
 *
 * Deliberately not memoized: v9 reuses the `header.column` object across
 * state changes, so caching this component keyed on that identity would
 * freeze `getIsSorted()`/`getIsPinned()` at their first-seen values and the
 * menu's sort and pin checkmarks would never track the real state.
 */
