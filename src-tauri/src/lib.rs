...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::db::get_timecards,
            commands::db::get_timecard,
            commands::db::create_timecard,
            commands::db::delete_timecard,
            commands::db::get_timecard_entries,
            ...
            commands::db::reopen_timecard,
            commands::db::get_mapping_rules,
            commands::db::create_mapping_rule,
            commands::db::update_mapping_rule,
            commands::db::delete_mapping_rule,
            commands::db::reorder_mapping_rules,
            commands::db::apply_mapping_rules,
            commands::db::get_unmapped_groups,
            commands::db::map_events,
            commands::db::unmap_events,
